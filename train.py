...
from metric_depth.dataset.kitti import KITTI
from metric_depth.dataset.vkitti2 import VKITTI2
from metric_depth.dataset.m3ed import M3ED
...
parser.add_argument('--dataset', default='m3ed', choices=['hypersim', 'vkitti', 'm3ed'])
